...
"""
Installation script for the Coral Dashboard.
"""
...
setup(
    name='coral_dashboard',
    version=find_version('coral_dashboard/__init__.py'),
    ...
    description=(
        'Dashboard (data visualizer) for the Coral Project (Gaming PC)'
    ),
    long_description=read('README.rst'),
    url='https://github.com/kuralabs/coral-dashboard',
    keywords='coral_dashboard',
    ...
    entry_points={
        'console_scripts': [
            'coral_dashboard = coral_dashboard.__main__:main',
        ]
    },
)
